...
public extension GNFont {
    ...
    /// GNFoundation: Static light font to use in App.
    ///
    /// Default is HelveticaNeueLight of size 12.
    @nonobjc static var gn_lightFont: GNFont = GNFont(gn_fontName: .helveticaNeueLight, gn_size: 12)
    
    /// GNFoundation: Static regular font to use in App.
    ///
    /// Default is HelveticaNeue of size 12.
    @nonobjc static var gn_regularFont: GNFont = GNFont(gn_fontName: .helveticaNeue, gn_size: 12)
    
    /// GNFoundation: Static bold font to use in App.
    ///
    /// Default is HelveticaNeueBold of size 12.
    @nonobjc static var gn_boldFont: GNFont = GNFont(gn_fontName: .helveticaNeueBold, gn_size: 12)
    
    // MARK: - Functions
    
    /// GNFoundation: Create an UIFont object from the given font name and size.
    ///
    /// - Parameters:
    ///   - fontName: Font name.
    ///   - size:     Size of the font.
    convenience init(gn_fontName: GNFontName, gn_size: CGFloat) {
        self.init(name: gn_fontName.rawValue, size: gn_size)!
    }
    
    /// Print in console all family and font names.
    ///
    /// - Returns: Returns all the font family names.
    static func gn_allFonts() -> [String: [String]] {
    ...
    /// GNFoundation: Print in console all font names for a given family.
    ///
    /// - Parameter familyFontName: Family fonts.
    /// - Returns: Returns all fonts for the given family.
    static func gn_fontNames(for family: GNFamilyFontName) -> [Any] {
